...
class TopologyOptimizer:
        ...
        for epoch in range(maxEpochs):
            ...
            if (epoch % 20 == 0):
                ...
                print("{:3d} J: {:.2F}; Vf: {:.3F}; loss: {:.3F}; relGreyElems: {:.3F} ; E11: {:.4F} ; E12: {:.4F} ; E13: {:.4F} ; E21: {:.4F} ; E22: {:.4F} ; E23: {:.4F} ; E31: {:.4F} ; E32: {:.4F} ; E33: {:.4F}" \
                      .format(epoch, self.objective.item() * self.obj0, currentVolumeFraction, loss.item(),
    ...
    def plotTO(self, iter, saveFig=False):
        ...
        plt.title('Iter = {:d}, J = {:.2F}, V_f = {:.2F}, V_des = {:.2F}'.format(iter, self.objective * self.obj0,
                                                                                 np.mean(density),
    ...
    def plotConvergence(self):
        ...
        plt.figure();
        plt.plot(self.convergenceHistory[:, 0], 'b', label='Objective')
    ...
    def mid_plotConvergence(self):
        ...
        plt.figure();
        plt.plot(mid[:, 0], 'b', label='Objective')
...
# %%
plt.close('all');
E_target = np.array([0.2033, 0.1555, 0, 0.1555, 0.2033,0, 0, 0, 0.1381])
